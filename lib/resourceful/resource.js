...
Resource.filter = function (name, filter) {
  return this._request("filter",
                       name,
                       { filter: filter, resource: this },
                       function () {});
};
...
Resource.child = function (resource, options) {
  this.engine._relationship(this, 'child', resource, options);
};
Resource.parent = function (resource, options) {
  this.engine._relationship(this, 'parent', resource, options);
};
