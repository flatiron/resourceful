...
Resource.save = function (obj, callback) {
  ...
  if (typeof obj._id !== 'undefined') {
    ...
    if(obj._id.indexOf(this.lowerResource + "/") === -1) {
      newid = this.lowerResource + "/" + obj._id;
    } else {
      newid = obj._id;
    }
    obj._id = newid;
    oldid = obj._id.replace(this.lowerResource + "/", '');
  } else {
    newid = this.lowerResource + "/" + resourceful.uuid.v4();
    oldid = newid;
  }
