...
var Resourceful = module.exports = function Resourceful(options) {
  ...
  this.resources = {};
  this.Resource = require('./resource')(this);
...
Resourceful.prototype.instantiate = function (resource, obj) {
  var instance, Factory, id, resourceful = this;

  Factory = resourceful.resources[resource.resource];

  id = obj[resource.key];

  if (id && resource.connection.cache.has(id)) {
    obj = resource.connection.cache.get(id);
  }
